                        ...
                        <div class="flex flex-col w-full max-w-full px-3 mx-auto md:flex-0 shrink-0 md:w-6/12 lg:w-5/12 xl:w-4/12">
                            <div class="relative flex flex-col min-w-0 mt-32 break-words bg-transparent border-0 shadow-none rounded-2xl bg-clip-border">
                                ...
                                <div class="flex-auto p-6">
                                    <!-- Error Messages -->
                                    @if ($errors->any())
                                    <div class="relative p-4 mb-4 text-white bg-red-500 border border-red-300 rounded-lg">
                                        <ul class="mb-0">
                                        ...
                                        <button type="button" onclick="this.parentElement.style.display='none'"
                                            class="absolute top-0 right-0 p-2 text-white bg-transparent border-0 rounded">
                                    ...
                                    @if (session('status'))
                                    <div class="relative p-4 mb-4 text-white bg-green-500 border border-green-300 rounded-lg">
                                        {{ session('status') }}
                                        <button type="button" onclick="this.parentElement.style.display='none'"
                                            class="absolute top-0 right-0 p-2 text-white bg-transparent border-0 rounded">
                                            <span aria-hidden="true" class="text-center cursor-pointer">&#10005;</span>
                                    ...
                                    <form wire:submit.prevent="login">
                                        ...
                                        @error('email')
                                        <p class="text-size-sm text-red-500 mb-2">{{ $message }}</p>
                                        @enderror
                                        ...
                                        <div class="min-h-6 mb-6 block pl-12">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" wire:loading.attr="disabled"
                                                class="inline-block w-full px-6 py-3 mt-6 mb-0 font-bold text-center text-white uppercase align-middle transition-all bg-transparent border-0 rounded-lg cursor-pointer shadow-soft-md bg-x-25 bg-150 leading-pro text-size-xs ease-soft-in tracking-tight-soft bg-gradient-cyan hover:scale-102 hover:shadow-soft-xs active:opacity-85 disabled:opacity-50">
                                ...
                                <div class="p-6 px-1 pt-0 text-center bg-transparent border-t-0 border-t-solid rounded-b-2xl lg:px-2">
                                    <p class="mx-auto mb-6 leading-normal text-size-sm">
                                        ...
                                        <a href="{{ route('forgot-password') }}"
                                            class="relative z-10 font-semibold text-transparent bg-gradient-cyan bg-clip-text">Reset here</a>.<br />
