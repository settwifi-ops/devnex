                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex-1">
                                        <div class="flex items-center space-x-3 mb-2">
                                            ...
                                            <span class="px-2 py-1 text-xs rounded-full 
                                                {{ strtoupper($order['status']) === 'FILLED' ? 'bg-green-100 text-green-800' : 
                                                   (strtoupper($order['status']) === 'PARTIALLY_FILLED' ? 'bg-yellow-100 text-yellow-800' : 
                                                   (strtoupper($order['status']) === 'CANCELLED' ? 'bg-red-100 text-red-800' : 
                                                   (strtoupper($order['status']) === 'NEW' ? 'bg-blue-100 text-blue-800' : 
